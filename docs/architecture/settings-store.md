...
**The benefit:** `RiverSession.subscribeToConfiguration()` looks like this:
...
- [river-session.md](river-session.md) — the primary non-SwiftUI consumer of settings publishers
