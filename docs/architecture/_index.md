...
How River is structured and why. Read in order on a first pass; reference individually thereafter.

- [overview.md](overview.md) — process model, target audience, the broad shape of the app
- [river-session.md](river-session.md) — the deep module that owns one full activation-to-paste cycle; consumes managers, holds the state machine, applies deferred reconfiguration
...
- [river-pipeline.md](river-pipeline.md) — one end-to-end cycle from keypress to pasted text; the state machine
