...
- **[0002](0002_recording-indicator-hud.md)/[0018](0018_transient-error-toasts.md)** — the HUD gains an optional segment-activity affordance later, driven by the side channel, not by new `RiverState` cases.
...
- [../architecture/river-session.md](../architecture/river-session.md) / [../architecture/river-pipeline.md](../architecture/river-pipeline.md) — the cycle and state machine this extends
