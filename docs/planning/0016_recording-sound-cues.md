...
- **A small observer of the state seam** (e.g. `SoundFeedbackController`) — subscribes to the same `RiverState` publisher the menu bar renders ([../architecture/app-state-and-menu-bar.md](../architecture/app-state-and-menu-bar.md)):
