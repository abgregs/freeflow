...
River runs with Microphone + Input Monitoring + Accessibility granted. A
...
- **Resolved (2026-06-15):** the onboarding "Skip (I've already granted
  ...
  local/self-signed builds, gated by the `RIVER_RELEASE` compile condition
  the release workflow sets (`-Xswiftc -DRIVER_RELEASE`). Its rationale —
