...
2. User clicks **Grant** → System Settings opens — and shows FreeFlow *already enabled* (a stale row bound to a previous binary; tccd does not authorize the running one). User reasonably concludes the app is wrong.
