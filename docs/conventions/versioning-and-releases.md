...
How River versions and ships. The release *mechanics* (secrets, workflow steps, how to cut a release) live in the [release-pipeline runbook](../architecture/release-pipeline.md); this doc is the *protocol* — what to tag, how to number, and what a release means per channel.
