---
name: debrief
description: Post-task debrief for River. Reviews code changes against docs/, proposes doc updates for new patterns or replaced conventions, and runs a doc health check. Use after completing any non-trivial code task.
---

You have just completed a code task in River. Review the changes against the project documentation so the docs stay aligned with the code.
