---
name: brief
description: Pre-task briefing for River. Surfaces applicable conventions, architectural constraints, and requirements from docs/ before planning a code change. Use when starting any non-trivial code task.
---

You are preparing to execute a code task in River. Before writing any code, ground yourself in the project's documentation and align your plan with established conventions.
